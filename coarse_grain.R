...
# the intersection does not change too much with the second coarse graining strategy
...
write.fasta(as.list(cg_immunogen), names = 1:length(cg_immunogen), file.out = "epitopes_cgimmunogen.fasta")
write.fasta(as.list(cg_nonimmunogen), names = 1:length(cg_nonimmunogen), file.out = "epitopes_cgnonimmunogen.fasta")
